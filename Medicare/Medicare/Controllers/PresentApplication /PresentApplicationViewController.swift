//
//  PresentApplicationViewController.swift
//  Medicare
//
...
final class PresentApplicationViewController: BaseViewController {
    ...
    fileprivate weak var tableViewController: PresentApplicationTableViewController!
    ...
    class func newInstance() -> PresentApplicationViewController {
        guard let newInstance = R.storyboard.presentApplication.presentApplicationViewController() else {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if let destination = segue.destination as? PresentApplicationTableViewController {
...
extension PresentApplicationViewController {
    ...
    override func reloadLocalizedViews() {
        ...
        title = R.string.localization.presentApplication.localized()
