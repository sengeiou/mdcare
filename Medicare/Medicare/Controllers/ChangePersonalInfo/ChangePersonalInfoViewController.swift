...
final class ChangePersonalInfoViewController: BaseViewController {
    ...
    fileprivate weak var tableViewController: ChangePersonalInfoTableViewController!
    fileprivate var router = ChangePersonalInfoRouter()

    // MARK: - Initialize

    class func newInstance() -> ChangePersonalInfoViewController {
        guard let newInstance = R.storyboard.myMenu.changePersonalInfoViewController() else {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if let destination = segue.destination as? ChangePersonalInfoTableViewController {
...
extension ChangePersonalInfoViewController {
